 ...
 * on 2018-02-14 at 23:44:26 UTC 
 * Modify at your own risk.
 */

package com.example.disen.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<com.example.disen.myapplication.backend.myApi.model.MyJokes> {

    private static final String REST_PATH = "myjokes";
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.disen.myapplication.backend.myApi.model.MyJokes.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.disen.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.disen.myapplication.backend.myApi.model.MyBean.class);
